<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newsEdit.aspx.cs" Inherits="HouTai_page_news_newsEdit" %>
...
<body class="childrenBody">
    <form id="Form1" class="layui-form" runat="server">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <asp:Button ID="Button1" runat="server" Text="退出" class="layui-btn" lay-submit="" lay-filter="addNews" />
                <asp:Button ID="Button2" runat="server" Text="重置" class="layui-btn layui-btn-primary" />
                <asp:Button ID="Button3" runat="server" class="layui-btn"  Text="保存" OnClick="Button3_Click" />
            </div>
        </div>
    </form>
