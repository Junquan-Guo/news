...
function (i) {
    ...
    u.prototype.config = function (i) {
        ...
        i), window.JSON && window.JSON.parse) return A(i),
        this
    },
    ...
    z = function (i) {
        ...
        if (a[0]) {
            ...
            1 !== s.find("li").length || o[0] || (d || w.css("width", 800), s.css({
                height: w.height()
            }).show(), u.css("margin-left", "200px")),
            o[0] || (s.append(n(v).render(l)), u.append(n(f).render(l)), I(i), E()),
    ...
    K = function (i) {
        ...
        if (w) {
            ...
            i.system ? l !== -1 && u.append('<li class="layim-chat-system"><span>' + i.content + "</span></li>") : "" !== i.content.replace(/\s/g, "") && u.append(n(h).render(i)),
            Z()
        }
    },
